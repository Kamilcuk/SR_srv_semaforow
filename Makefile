...
# Template: app
# Command: /usr/bin/qmake -o Makefile SR_srv_semaforow.pro
#############################################################################
...
CXXFLAGS      = -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -std=gnu++1y -Wall -W -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = SR_srv_semaforow1.0.0
DISTDIR = /home/projects/allrepos/SR_srv_semaforow/.tmp/SR_srv_semaforow1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		SR_srv_semaforow.pro client.hpp \
		helpers.hpp \
		server.hpp \
		semaphore.hpp client.cpp \
		main.cpp \
		server.cpp \
		server_logic.cpp \
		helpers.cpp \
...
Makefile: SR_srv_semaforow.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile SR_srv_semaforow.pro
...
server_logic.o: server_logic.cpp server.hpp \
		semaphore.hpp \
		helpers.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o server_logic.o server_logic.cpp

helpers.o: helpers.cpp server.hpp \
		semaphore.hpp \
		helpers.hpp
